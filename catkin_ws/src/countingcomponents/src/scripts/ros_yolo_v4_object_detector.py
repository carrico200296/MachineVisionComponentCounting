...
class image_converter:
    def __init__(self):
        ...
        # Load Yolo v4
        self.model_weights = "yolo_models/yolov4.weights"
        self.model_cfg = "yolo_models/yolov4_testing_nut.cfg"
    ...
    def save_image(self,frame_detected,frame_original,num_objects):
        ...
        cv2.imwrite("pilot_test/yolov4_tiny_416_07_04/nut_{}.png".format(img_nr), frame_original)
        cv2.imwrite("pilot_test/yolov4_tiny_416_07_04/nut_{}_predicted.png".format(img_nr), frame_detected)  
